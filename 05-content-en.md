...
**PRIVATE ADDICTION-TREATMENT PLACEMENT IN EUROPE**
...
When your loved one is ready to accept help, the window can be brief. We help families in the United States and Canada identify suitable European treatment options, confirm availability and coordinate admission and travel.
...
Your information is handled confidentially and is used only to respond to your request.
...
**Why families consider treatment in Europe**
...
Suitable programs may have availability within days, depending on clinical fit and current capacity.
...
Treatment begins away from the places, people and routines connected with continued use.
...
Being far from home can make impulsive returns to the previous environment more difficult and give treatment time to take hold.
...
We help coordinate assessment, placement, travel, airport pickup and communication with the family.

## Assessment

Heading:

**Is treatment in Europe a realistic option for your family?**

Body:

Answer four short questions. We will review the information and explain which options may be appropriate.

Confidentiality note:

Your answers are private and do not commit you to treatment.
...
Programs for minors require separate clinical and legal review.
...
An admissions coordinator will review the information and contact you using the details provided.
...
**A clear path from first call to admission**

Step 1:

**Confidential consultation**

We listen to what is happening, clarify urgency and explain whether international treatment may be realistic.

Step 2:

**Initial assessment**

We gather the clinical, practical and travel information needed to identify appropriate options.

Step 3:

**Treatment matching**

We present suitable programs based on clinical needs, budget, availability and level of support.

Step 4:

**Travel coordination**

We help organize documentation, flights, arrival instructions, airport pickup and private transfer.

Step 5:

**Admission and handoff**

The receiving program completes its admission process and takes responsibility for treatment.
...
Clinical services are provided by the selected treatment program, not by European Recovery Access.

## Trust section

Heading:

**Built for families who need clarity quickly**

Items:

**One point of contact**

You do not have to coordinate several unfamiliar providers at once.

**Options based on fit**

We consider clinical needs, urgency, budget, setting and travel requirements.

**Clear costs before commitment**

You receive the available program and coordination costs before making a decision.

**Support across time zones**

Admissions communication is arranged for families in the United States and Canada.
...
**When another first step may be necessary**
...
### Can the family remain involved?
...
**Your family may only get one clear window for treatment.**

Body:

We help you understand the options and move quickly when the time is right.
